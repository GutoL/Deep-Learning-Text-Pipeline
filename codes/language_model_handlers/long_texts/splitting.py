...
# Functions for preparing input for longer texts - based on https://github.com/mim-solutions/bert_for_longer_texts/blob/main/belt_nlp/splitting.py
...
def transform_single_text(text: str, tokenizer: PreTrainedTokenizerBase, chunk_size: int, stride: int, minimal_chunk_length: int, 
                          maximal_text_length: Optional[int]) -> tuple[Tensor, Tensor]:
